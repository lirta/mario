                ...
                <nav class="navbar navbar-expand">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <div class="header-message-list">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center">
                                                <div class="user-online">
                                                    <img src="{{ asset('assets/images/avatars/avatar-10.pn')}}g" class="msg-avatar" alt="user avatar">
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <a class="dropdown-item" href="javascript:;">
                                            <div class="d-flex align-items-center">
                                                <div class="user-online">
                                                    <img src="{{ asset('assets/images/avatars/avatar-11.pn')}}g" class="msg-avatar" alt="user avatar">
                                                </div>
                                                <div class="flex-grow-1">
                    ...
                    <div class="user-box dropdown border-light-2">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							@else
                            	<img src="{{ asset('assets/images/staff/'.@Auth::user()->photo)}}" class="user-img" alt="user avatar">
							@endif
                            <div class="user-info ps-3">
                                <p class="user-name mb-0">{{@Auth::user()->email}}</p>
                                <p class="designattion mb-0">Staff</p>
                            </div>
                        </a>
