								...
								<div class="card-body">
									<div class="row mb-3">
										...
										<div class="col-sm-9 text-secondary">
											<input type="text" id="layanan" class="form-control @error('layanan') is-invalid @enderror"  name="layanan" value="{{$layanan->layanan}}" placeholder="@lang('Name Layanan')"/>
											@error('layanan')
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9 text-secondary">
											<input type="number" id="waktu" class="form-control @error('waktu') is-invalid @enderror"  name="waktu" value="{{$layanan->perkiraan_waktu}}" placeholder="@lang('ex: 60')"/>
											@error('waktu')
												<div class="invalid-feedback">
													{{$message}}
												</div>
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9 text-secondary">
											<textarea name="des" id="des"  class="form-control @error('des') is-invalid @enderror"  cols="30" rows="3" placeholder="Description">{{$layanan->description}}</textarea>
										</div>
									</div>
